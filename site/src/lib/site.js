...
export const SITE = {
  // Endereço oficial do site. É daqui que saem as URLs canônicas, o sitemap e
  // o RSS, então ele precisa ser sempre o domínio que você divulga.
  url: "https://lageinvestimentos.com.br",
